...
class SomaInvestimentos:
    ...
    def le_csv(self):
        with open(self.nome_arquivo, 'r', newline='', encoding='latin-1') as arquivo:
...
def main():
    nome_do_arquivo = 'Exportar_custodia_2023-06-15.csv'  # Substitua pelo nome do seu arquivo CSV
